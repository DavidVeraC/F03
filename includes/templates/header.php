        ...
        <div class="items">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown p-2">
                    <a style="color:#fff;" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">OPCION 1</a>
            ...
            <ul>
                <li class="submenu">
                    ...
                    <div id="carrito">       
                        ...
                        <a href="lista-pedido.php" id="lista-pedido" class="">Listar Pedido</a>
                    </div>
                </li>
            </ul>
